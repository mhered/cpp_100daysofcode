...
protected:
	...
	bool OnUserCreate() override
	{
		...
		std::string path = "/home/mhered/cpp_100daysofcode/code/Day093_27-06-23/AsteroidsSoundSDL/soundclips/";

		fire.load(path + "phaser2.wav");
		//explosion.load(path + "explosion.wav");
		//thrust.load(path + "thrust-xxs.wav");
		...
		for (auto &b : vecBullets)
		{
			...
			for (auto &a : vecAsteroids)
			{
				...
				if (IsPointInsideCircle(a.x, a.y, a.nSize, b.x, b.y))
				{
					...
					// Play sound effect: asteroid explosion
					//explosion.play();
				}
			}
		}
