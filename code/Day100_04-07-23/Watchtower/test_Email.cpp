...
TEST(EmailExtractorTest, TestCaseFromFile1)
{
    ...
    EXPECT_EQ(email.from, "spam.mhered@gmail.com");
...
// Test case for extracting email fields, reads from file
TEST(ParserFunctionsTest, ExtractEmailTest)
{

    std::string rawemail = extractEmail("Manuel Heredia <spam.mhered@gmail.com>");

        // Assert expected values
        EXPECT_EQ(rawemail, "spam.mhered@gmail.com");
}
